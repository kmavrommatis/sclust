...
ifeq ($(UNAME_S),Linux)
  LIBZ  = samtools/libbam.a -lz $(MORELIBS)
endif
ifeq ($(UNAME_S),Darwin)
  LIBZ  = samtools/libbam.a /usr/lib/libz.dylib $(MORELIBS)
endif
...
ifndef R_EX
	...
	mkdir -p ./bin
	@echo [Linking] $@ "\c"
	@$(CCC) $(CCFLAGS)  -o ./bin/Sclust Sclust.o $(MODULES) $(NUM) $(LIBZ)
	@echo " ...done."
...
./openBLAS/lib/libopenblas.a:
	...
	make -C $(OBLAS) DYNAMIC_ARCH=1 >./OpenBLAS_Install.log 2>&1
	@tail -n12 ./OpenBLAS_Install.log
	@echo "Installing BLAS libraries and cleaning up..."
	make -C $(OBLAS) install PREFIX=`pwd`/openBLAS >>./OpenBLAS_Install.log 2>&1
	rm -r $(OBLAS)
	@echo " ...done."
